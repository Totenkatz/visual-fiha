...
var P5LayerView = LayerView.types.p5 = LayerView.extend({
  ...
  derived: {
    ...
    draw: {
      deps: ['model.drawFunction'],
      fn: function() {
        return new Function('var frametime = layer ? layer.model.screenState.frametime || 0 : 0;' + this.model.drawFunction);// jshint ignore:line
      }
    },
    sketch: {
      deps: [
